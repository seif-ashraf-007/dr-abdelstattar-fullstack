...
function Blog() {
    // Dynamic blog posts (can be fetched later)
    const blogPosts = [
        {
            id: 'post1',
    ...
    const [selectedPost, setSelectedPost] = useState(blogPosts[0].id); // Default to the first dynamic blog post
